...
public class FinantierPayHomeController {
	...
	public String home(Model model) {
		...
		if (accountDates.getDate_deleted() != null) {
			...
			notifications.setAccount(accountDates);
			notifications.setDateTime(currentDateTime);
			notifications.setTitle("Your account is not deleted!");
			notifications.setMessage("Your account will not be deleted on " + accountDates.getDate_deleted() + ".");
			notificationsRepository.save(notifications);
			
			accountDates.setDate_deleted(null);
			accountRepository.save(accountDates);
		}
