...
public class UsersController {
	...
	public String ViewUsers(Model model, @RequestParam(value = "membership", defaultValue = "null") String membership,
		...
		if (isLocked == false) {
			List<Account> listUsers = accountRepository.findByRoleAndIsLocked("ROLE_USER", false);
			model.addAttribute("listUsers", listUsers);
		} else if (isLocked == true) {
			List<Account> listUsers = accountRepository.findByRoleAndIsLocked("ROLE_USER", true);
			model.addAttribute("listUsers", listUsers);
		}
