...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/cswshoes", "/pagetwo/*", "/shoppingcart", "/shoppingcart/add/*", "/shoppingcart/delete/*", "/shoppingcart/edit/*", "/transaction_successful").permitAll()
		...
		.antMatchers("/help", "/settings", "/account", "/uploads/rewards/*/*").hasAnyRole("USER", "MERCHANT", "STAFF", "ADMIN")
		.antMatchers( "/membership", "/membership/points", "/wallet/create", "/wallet/confirmpin","/wallet/*/topup", "/wallet/process_topup", "/wallet/*/send", "/wallet/*/confirm", "/wallet/*/success", "/wallet/*/transactionhistory", "wallet/*/delete", "/rewards/redeem/*", "/voucher/redeem/*", "/voucher", "/pointshistory", "/wallet/current/*", "/wallet/updatepin/*" , "/wallet/confirmupdatepin/*", "/wallet/saveupdatepin/*", "/account/deleted/*").hasRole("USER")
		...
		.antMatchers("/notifications","/notifications/delete/*", "/notifications/delete", "/notifications/read/*", "/account/edit/*", "/account/password/edit/*", "/account/delete/*", "/wallet", "/wallet/save", "/transactionhistory", "/account/*/wallet", "/wallet/*", "/wallet/withdraw/", "/process_help").hasAnyRole("USER", "MERCHANT")
